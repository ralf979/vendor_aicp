...
# AICP Hidden API whitelist
PRODUCT_COPY_FILES += \
    vendor/aicp/config/permissions/aicp-hiddenapi-package-whitelist.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/aicp-hiddenapi-package-whitelist.xml
